...
public class SuperCriticalBoilers extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.supercriticalboilers);
        ...
        sw.setImageResource(R.mipmap.b3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(j<3) {
                    Toast.makeText(SuperCriticalBoilers.this, "Next Image", Toast.LENGTH_SHORT).show();


                    j++;

                    if (j == 1)
                        sw.setImageResource(R.mipmap.a3);
                    else if (j == 2) sw.setImageResource(R.mipmap.b3);
                    else if (j == 3)
                        sw.setImageResource(R.mipmap.c3);
                }
                else Toast.makeText(SuperCriticalBoilers.this, "End of Pics", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(j>1)
                {
                    Toast.makeText(SuperCriticalBoilers.this, "Previous Image", Toast.LENGTH_SHORT).show();
                    j--;
    ...
    public void videoplay(View v) {
        i++;
        String videopath = "android.resource://" + getPackageName() + "/" + R.raw.supercritically;
